...
/**
 * This class is used to parse a date string into
 * a valid ISO8601 formatted date string via
 * the static parseText method.
 * @author josh
 *
 */
public class DateConverter {			
	 ...
	 * @return	String representing the date in valid ISO8601 format.
	 */
	public static String parseText(String date){ ArrayList<DateFormat> formats = new ArrayList<DateFormat>();
